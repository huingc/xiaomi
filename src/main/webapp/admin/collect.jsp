...
<div class="row top-nav">
    ...
    <div class="col-md-6">
        <%--<form action="/collect/allCollectName.action" class="form-inline pull-right" role="form">--%>
            <%--<div class="form-group">--%>
                <%--<input type="text" class="form-control" id="pName" name="pName" placeholder="请输入商品名称进行搜索">--%>
            <%--</div>--%>
    ...
    <div class="col-md-offset-1 col-md-10">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="/collect/allCollect.action" role="form">
                    <!--购物车表格开始-->
                    <table class="cart-table" width="100%">
                        ...
                        <c:forEach items="${collectList}" var="c">
                            <c:forEach items="${c.productInfoList}" var="cp">
                                <tr>

                                    <td>
                                        <input type="checkbox" name="cid" class="ckitem" value="${c.cid}"/>
                                    </td>
                                    <input type="hidden" name="cid" value="${c.cid}"/>
                                    <td>${cp.pName}</td>
                                    <td>${cp.pContent}</td>
                                    <td><img src="../images/${cp.pImage}" class="img-responsive"/>
                                    </td>
                                    <td>
                                        <button type="button" class="cart-del btn btn-default btn-xs">
                                            <a href="/collect/deleteCollect.action?cid=${c.cid}">删除</a>
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
