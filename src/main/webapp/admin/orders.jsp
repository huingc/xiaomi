...
<div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div><a href="/orders/toorders.action"><b>全部订单</b></a></div>
    ...
    <div class="col-md-10">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="panel-title">
                    订单号：${b.bid}，下单时间：<fmt:formatDate value='${b.date}' pattern='yyyy-MM-dd'/> ，收货人：八戒
                </p>
            </div>
            <div class="panel-body">
                <table class="orders-table" width="100%">
                    ...
                    <c:forEach items="${b.billInfo}" var="p" >
                        <tr>
                            <td><img src="../images/${p.productInfo.pImage}" class="img-responsive"/></td>
                            <td>${p.productInfo.pName}  ${p.productInfo.pContent}</td>
                            <td>¥<span>${p.productInfo.pPrice}</span></td>
                            <td>${p.num}件</td>
                            <td>¥<span>${p.num*p.productInfo.pPrice}</span></td>
                            <td><a href="#">申请售后</a></td>
                            <td>
                                <div>已发货</div>
                ...
                <div>
                    <span class="pull-right">订单总金额：${b.total}</span>
                </div>
            </div>
        </div>
        </c:forEach>
