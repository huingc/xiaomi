    ...
    <div class="col-md-offset-1 col-md-10">
        <div class="col-md-6">
            <div data="1" class="img-big move-img col-md-12">
                <img id="product-image-1-big" src="../images/${info.pImage}"
                     class="img-responsive"/>
            </div>
        </div>
        <div class="col-md-6">
            <h3  class="col-md-12 title-row-1">${info.pName}</h3>
            <h3  class="col-md-12 title-row-1">${info.pContent}</h3>
            <p id="product-sell-point" class="col-md-12 text-row-1"><small>仅上海，广州，沈阳仓有货！预购从速！</small></p>
            <div class="col-md-12 price-bar">
                <small>学员售价：</small> ¥<span id="product-price">${info.pPrice}</span>
            ...
            <form class="form-inline product-form col-md-12" role="form">
                ...
                <div class="col-md-12 form-space">
                    ...
                    <input id="num" name="num" type="text" size="2" readonly="readonly" class="num-text" value="1">
                ...
                <div class="col-md-12 form-space">
                    <input class="btn btn-primary btn-lg btn-block" type="button" value="立即购买" onclick="settlement()">
                </div>
                <div class="col-md-12 form-space">
                    <button type="button" class="btn btn-default" onclick="addcart()"><span
                            class="fa fa-cart-plus"></span> 加入购物车
                    </button>
                </div>
                <div class="col-md-12 form-space">
                    <a href="/collect/addCollect.action?pid=${info.pId}">
    ...
    <div class="col-md-offset-1 col-md-10">
        <div class="panel panel-default">
            ...
            <div class="panel-body ">
                ...
                <div class="row">
                    <p class="col-md-offset-1 col-md-11 saled-content">
                        客户购买电脑商城商品7日内（含7日，自客户收到商品之日起计算），在保证商品完好的前提下，可无理由退货。（部分商品除外，详情请见各商品细则）</p>
                </div>
...
<script type="text/javascript">
    ...
    function settlement() {
        $.ajax({
            url: "${pageContext.request.contextPath}/orders/addbillandbillinfo.action",
            type: "POST",
            data: {
                "pid": ${info.pId},
                "amount": $("#num").val()
            ...
            success: function () {
                alert("购买成功！");
                window.location.href='${pageContext.request.contextPath}/orders/toorders.action';
            },
        });
    };
